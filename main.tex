...
\end{verbatim}
 ...
 \begin{figure} [H]
     \centering
     \includegraphics[width=0.5\linewidth]{ExampleDerivation.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{followExample.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{predict.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{shiftRecuceParsing.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{stackbasedAllocation.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{dynamicScoping.png}
...
\begin{figure}  [H]
    \centering
    \includegraphics[width=0.5\linewidth]{precedenceLevelsInC.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{lambda1.png}
    \caption{Example}
